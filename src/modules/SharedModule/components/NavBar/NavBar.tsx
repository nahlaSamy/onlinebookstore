                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    <Nav>
                        <NavDropdown
                            ...
                            className='me-auto'
                        >
                            <NavDropdown.Item href="#" onClick={handleShow}> <i className="fa-solid fa-key fa-xs mx-2"></i>Change Password</NavDropdown.Item>
                            <NavDropdown.Divider />
                            <NavDropdown.Item onClick={handleLogout}> <i className="fa-solid fa-right-from-bracket fa-xs mx-2"></i>Logout</NavDropdown.Item>
                        </NavDropdown>
                        <Nav.Link> <i className="fas fa-shopping-bag fa-lg mx-2"></i></Nav.Link>
                        <Nav.Link> <i className="fa-regular fa-heart fa-lg mx-2"></i></Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
